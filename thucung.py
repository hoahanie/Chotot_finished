...
class thucungSpider(scrapy.Spider):
    name = 'thucung'
    headers = {
        "accept": "*/*",
    ...
    def start_requests(self):
        with open('city_name.json','r') as f:
            ...
            for city in data:
                ...
                filename = './output/thucung/' + seo_url+'_' + datetime.datetime.today().strftime('%Y-%m-%d-%H-%M') + '.jsonl'

                query_string_params ='?cg=12000&region_v2={}&st=s,k&w=1&limit=50&w=1'.format(city_id)
    ...
    def parse_page(self, response):
        ...
        for page in range(1,number_page+1):
            query_string_params = '?o={}&page={}&cg=12000&region_v2={}&st=s,k&w=1&limit=50&w=1'.format((page-1)*50,page,city_id)
