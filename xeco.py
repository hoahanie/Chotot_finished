...
# from items import xecoItem


class xecoSpider(scrapy.Spider):
    name = 'xeco'
    headers = {
        "accept": "*/*",
...
# https://gateway.chotot.com/v1/public/ad-listing?o=60&region_v2=13000&cg=2000&st=s,k&w=1&limit=20&key_param_included=true
    ...
    def start_requests(self):
        with open('city_name.json','r') as f:
            ...
            for city in data:
                ...
                filename = './output/xeco/' + seo_url+'_' + datetime.datetime.today().strftime('%Y-%m-%d-%H-%M') + '.jsonl'
                query_string_params ='?o=0&region_v2={}&cg=2000&st=s,k&w=1&limit=50&key_param_included=true'.format(city_id)
    ...
    def parse_page(self, response):
        ...
        for page in range(1,number_page+1):
            query_string_params = '?o={}&region_v2={}&cg=2000&st=s,k&w=1&limit=50&key_param_included=true'.format((page-1)*50,city_id)
