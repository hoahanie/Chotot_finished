...
class muaBanBdsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        with open('city_name.json','r') as f:
            ...
            for city in data:
                ...
                filename = './output/muaban/' + seo_url+'_' + datetime.datetime.today().strftime('%Y-%m-%d-%H-%M') + '.jsonl'

                query_string_params = '?region_v2={}&cg=1000&limit=50&st=s,k'.format(city_id)
    ...
    def parse_page(self, response):
        ...
        for page in range(1,number_page+1):
            query_string_params ='?region_v2={}&cg=1000&limit=50&o={}&st=s,k&page={}'.format(city_id,(page-1)*50,page)
